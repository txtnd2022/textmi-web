...
export const FEATURES_CONTROLLER = [
    
    {
        ...
        'custome_header' : 'dms',
        'Image_Src': F3,
        'Body' : 'Fully end-to-end encrypted and peer-to-peer connected chats let you chat with your people without worry of getting tracked. Create specific groups and chat with your friends or family. Take control of your ultimate privacy.',
    },
    {
        'Key': 1,
